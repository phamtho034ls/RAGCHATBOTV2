...
Phần **Căn cứ pháp lý** ở cuối (nếu có): gom theo từng văn bản — mỗi dòng một văn bản, liệt kê các Điều trên cùng dòng.
Ví dụ: `- 86/2023/NĐ-CP: Điều 7, 8` hoặc `- 38/2021/NĐ-CP: Điều 36, 56, 57` — KHÔNG lặp lại tên văn bản đầy đủ cho từng Điều.
